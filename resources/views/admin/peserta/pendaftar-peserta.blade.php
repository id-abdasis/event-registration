                                ...
                                <div class="form-row">
                                  <div class="col-md-8">
                                    <div class="form-group">
                                      ...
                                      <input required type="text" placeholder="Masukan Tempat Lahir" name="tempat_lahir" id="tempat_lahir" class="form-control">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input required placeholder="Pilih Tanggal Lahir" type="date" class="form-control" name="tanggal_lahir"> 
