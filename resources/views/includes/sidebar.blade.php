<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown {{ Request::route()->getName() == 'peserta.daftar-peserta' ? ' active' : '' }}">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-book"></i><span>Data Peserta</span></a>
        <ul class="dropdown-menu">
          <li class="{{ Request::route()->getName() == 'peserta.daftar-peserta' ? ' active' : '' }}"><a class="nav-link" href="{{ route('peserta.daftar-peserta') }}">List Peserta</a></li>
        </ul>
      </li>
